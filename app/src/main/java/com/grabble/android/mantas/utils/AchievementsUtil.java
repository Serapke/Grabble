...
public class AchievementsUtil {
    ...
    public AchievementsUtil(Context context, SQLiteDatabase db) {
    ...
    private void checkChristmasAchievement() {
    ...
    private void checkEasterAchievement() {
        Calendar calendar = GregorianCalendar.getInstance(TimeZone.getTimeZone("GMT"));
    ...
    private void checkLetterNearStarbucksAchievement(LatLng letterPosition) {
    ...
    private void checkLetterNearForrestHillAchievement(LatLng letterPosition) {
    ...
    private void checkLetterNearLidlAchievement(LatLng letterPosition) {
    ...
    private void checkLetterNearMainLibraryAchievement(LatLng letterPosition) {
    ...
    private void checkLetterNearTeviotAchievement(LatLng letterPosition) {
    ...
    private void checkLetterNearAppletonTowerAchievement(LatLng letterPosition) {
    ...
    public void checkFirstPlaceAchievement(Integer place) {
    ...
    private void checkAlphabetAchievement() {
    ...
    public void checkAlphabetAchievement(Integer count) {
        ...
        Achievement achievement = dbHelper.getAchievement(db, achievementTitle);
        if (achievement.isLocked() && count.equals(ALPHABET_SIZE)) {
            dbHelper.unlockAchievement(db, achievementTitle);
        }
    }
    ...
    public void checkLocationAchievements(LatLng position) {
    ...
    public void checkLeaderboardAchievements(Integer place) {
        ...
        checkFirstPlaceAchievement(place);
    }
}
